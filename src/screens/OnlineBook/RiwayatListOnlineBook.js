...
class RiwayatListOnlineBook extends Component {
    constructor(props) {
        super(props);
    ...
    _renderItem = ({ item, index }) => {
        ...
        return (
            <ListItem avatar button key={index} onPress={() => this.props.navigation.navigate('detailOnlineBook', { ...item })}>
                <Left style={{ width:50 }}>                
                ...
                <Body>
                    ...
                    <NumberFormat value={Math.round(totalFee)} displayType={'text'} thousandSeparator={'.'} decimalSeparator={','} prefix={'Rp '} renderText={value => <Text note>Estimasi Biaya : {value}</Text>} />
                </Body>
                <Right>													
...
export default RiwayatListOnlineBook;